...
public class EditRegexDialog extends JDialog {
	...
	public EditRegexDialog(PacketRegex regex, RegexTableModel regexTableModel, RelayController controller) {
	...
	private void initGui() {
		...
		setTitle("Edit pre-parse modifier");
	...
	protected void saveRegex() {
		editRegex.setActive(chckbxActive.isSelected());
		editRegex.setRegex(textFieldRegex.getText());
		editRegex.setReplaceWith(textFieldReplace.getText());

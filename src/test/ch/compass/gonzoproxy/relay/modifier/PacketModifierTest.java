...
//		packetModifier.createRule("Modified Packet", rule, false);
//
...
//		packetModifier.createRule("Modified Packet", addedRule, false);
//		
...
//
//		packetModifier.createRule("Modified Packet", rule, true);
//
//		String fakePlainApdu = "00 a4 04 00 07 d2 76 00 00 85 01 01 00";
//		Packet receivedPacket = new Packet();
//		receivedPacket.setOriginalPacketData(fakePlainApdu.getBytes());
